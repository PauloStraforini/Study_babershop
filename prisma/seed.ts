  ...
  try {
    ...
    const services = [
      ...
      },
      {
        ...
        price: 25.0,
        imageUrl: "https://utfs.io/f/c4919193-a675-4c47-9f21-ebd86d1c8e6a-4oen2a.png", // Corrigido o URL
      },
    ];
    ...
    for (let i = 0; i < 10; i++) {
      ...
      // Criar a barbearia no banco de dados
      ...
      // Adicionar os serviços para cada barbearia
      for (const service of services) {
        await prisma.service.create({
          data: {
            ...
            price: service.price,
            imageUrl: service.imageUrl, // Adicionado o campo imageUrl
            barbershop: {
              connect: {
                id: barbershop.id,
              },
    ...
    await prisma.$disconnect(); // Certificar-se de desconectar o banco em caso de erro também
  }
}
